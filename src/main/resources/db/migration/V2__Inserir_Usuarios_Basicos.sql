...
-- Inserir Boleto
INSERT INTO BOLETO (ID, BANCO_FK, VALOR, DATA_VENCIMENTO, TOTAL_PARCELAS, CONVENIO, CODIGO_CEDENTE, CODIGO_TRANSMISSAO,
                    MODALIDADE,
...
VALUES ('c1d2e3f4-a5b6-7b8c-9d0e-2f3a4b5c6d7e', 'f6a7b8c9-d0e1-2f3a-4b5c-6d7e8f90a1b2', '1500.00',
        CURRENT_DATE + INTERVAL '10' DAY, '12', '10', '05', '08', '01', '02',
       ...
       ('d2e3f4a5-b6c7-8c9d-0e1f-3a4b5c6d7e8f', 'a7b8c9d0-e1f2-3a4b-5c6d-7e8f90a1b2c3', '2500.00',
        CURRENT_DATE + INTERVAL '5' DAY, '06', '12', '06', '09', '02', '03',
       ...
       ('e3f4a5b6-c7d8-9d0e-1f2a-4b5c6d7e8f90', 'b8c9d0e1-f2a3-4b5c-6d7e-8f90a1b2c3d4', '3500.00',
        CURRENT_DATE - INTERVAL '3' DAY, '08', '14', '07', '10', '03', '04',
       ...
       ('f4a5b6c7-d8e9-0e1f-2a3b-5c6d7e8f90a1', 'c9d0e1f2-a3b4-5c6d-7e8f-90a1b2c3d4e5', '4500.00',
        CURRENT_DATE + INTERVAL '5' DAY, '10', '16', '08', '11', '04', '05',
       ...
       ('a5b6c7d8-e9f0-1f2a-3b4c-6d7e8f90a1b2', 'd0e1f2a3-b4c5-6d7e-8f90-a1b2c3d4e5f6', '5500.00',
        CURRENT_DATE + INTERVAL '3' DAY, '04', '18', '09', '12', '05', '06',
       ...
       ('c953834d-1da7-4db3-bafc-51d849df6004', 'f6a7b8c9-d0e1-2f3a-4b5c-6d7e8f90a1b2', '3000.00',
        CURRENT_DATE + INTERVAL '15' DAY, '15', '11', '04', '07', '01', '02',
       ...
       ('34c6091c-9a8c-4537-82cf-d1a61210a8dd', 'a7b8c9d0-e1f2-3a4b-5c6d-7e8f90a1b2c3', '4000.00',
        CURRENT_DATE + INTERVAL '8' DAY, '03', '12', '07', '10', '02', '03',
       ...
       ('8bb04988-d014-4e80-a44e-19a1edaaebe9', 'a7b8c9d0-e1f2-3a4b-5c6d-7e8f90a1b2c3', '5000.00',
        CURRENT_DATE + INTERVAL '2' DAY, '10', '14', '08', '11', '03', '04',
       ...
       ('55fc1d96-a9eb-4881-a8df-04b645c0c672', 'a7b8c9d0-e1f2-3a4b-5c6d-7e8f90a1b2c3', '6000.00',
        CURRENT_DATE - INTERVAL '1' DAY, '02', '16', '09', '12', '04', '05',
        '06', '09', 'e1f2a3b4-c5d6-7e8f-90a1-b2c3d4e5f6a7', '04', '05', 'd6e7f8a9-b0c1-2c3d-4e5f-7a8b9c0d1e2f', '04',
        'Operacao9', 'chavePix9', '04',
        'VENCIDO', 'https://boleto9.com.br'),
       ('3ee35a09-01ea-4174-ba2c-ebf4c743cae3', 'a7b8c9d0-e1f2-3a4b-5c6d-7e8f90a1b2c3', '7000.00',
        CURRENT_DATE + INTERVAL '25' DAY, '05', '18', '10', '13', '05', '06',
        '07', '10', 'e1f2a3b4-c5d6-7e8f-90a1-b2c3d4e5f6a7', '05', '06', 'd6e7f8a9-b0c1-2c3d-4e5f-7a8b9c0d1e2f', '05',
        'Operacao10', 'chavePix10', '05',
